...
const catalog: AuthoredCatalog = {
  ...
  tracks: [
    ...
    expandCourseTrack(langgraphTrack, { targetLessons: 42, stageCount: 7, projectCount: 4, stageTitles: ["图基础", "状态与路由", "持久化", "记忆", "中断与恢复", "多 Agent", "Graph 项目"], familyIds: { "langgraph-lesson-11": "langgraph-review-project-v1", "langgraph-lesson-17": "langgraph-dispatch-project-v1" } }),
  ],
};
