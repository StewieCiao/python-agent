...
const catalog: AuthoredCatalog = {
  ...
  tracks: [
    ...
    expandCourseTrack(langchainRagTrack, { targetLessons: 48, stageCount: 7, projectCount: 4, stageTitles: ["模型与提示", "Runnable", "文档处理", "向量检索", "RAG 生成", "评估与观测", "RAG 项目"], familyIds: { "langchain-rag-lesson-20": "langchain-tool-assistant-v1" } }),
    expandCourseTrack(langgraphTrack, { targetLessons: 42, stageCount: 7, projectCount: 4, stageTitles: ["图基础", "状态与路由", "持久化", "记忆", "中断与恢复", "多 Agent", "Graph 项目"] }),
  ],
};
